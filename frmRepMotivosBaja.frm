...
Begin VB.Form frmRepMotivosBaja 
   ...
   ClientTop       =   330
   ClientWidth     =   4770
   Icon            =   "frmRepMotivosBaja.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "Código Motivo|N|N|1|99|smotba|codmotiv|00|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   20
      TabIndex        =   1
      Tag             =   "Desc. Motivo|T|S|||smotba|desmotiv||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmRepMotivosBaja.frx":000C
      Height          =   4725
      Left            =   120
      TabIndex        =   8
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRepMotivosBaja"
...
Dim tots As String
    ...
    tots = "S|txtAux(0)|T|Motivo|700|;S|txtAux(1)|T|Descripción|2900|;"
