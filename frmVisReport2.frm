...
'    Informe = "C:\Programas\Ariges 4\Informes\rptMarcas.rpt"
    ...
    For i = 1 To mrpt.Database.Tables.Count
       If mrpt.Database.Tables(i).ConnectionProperties.item("DSN") = "vAritaxi" Then
            mrpt.Database.Tables(i).SetLogOnInfo "vAritaxi", vEmpresa.BDAritaxi, "root", "aritel"
            ...
            Else
                If InStr(1, mrpt.Database.Tables(i).Name, "_alias") <> 0 Then
                    mrpt.Database.Tables(i).Location = vEmpresa.BDAritaxi & "." & Replace(mrpt.Database.Tables(i).Name, "_alias", "")
                End If
            End If
       End If
    Next i
    ...
    If InfConta Then
        For i = 1 To mrpt.Database.Tables.Count
           mrpt.Database.Tables(i).SetLogOnInfo "vconta", , "root", "aritel"
             ...
             If TypeOf crxObject Is SubreportObject Then
                ...
                For i = 1 To smrpt.Database.Tables.Count 'para cada tabla
                    ...
                    If smrpt.Database.Tables(i).ConnectionProperties.item("DSN") = "vAritaxi" Then
                        smrpt.Database.Tables(i).SetLogOnInfo "vAritaxi", vEmpresa.BDAritaxi, "root", "aritel"
                        ...
                        Else
                            If InStr(1, smrpt.Database.Tables(i).Name, "_alias") <> 0 Then
                                smrpt.Database.Tables(i).Location = vEmpresa.BDAritaxi & "." & Replace(smrpt.Database.Tables(i).Name, "_alias", "")
                            End If
                        End If
