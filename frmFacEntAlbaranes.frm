...
Begin VB.Form frmFacEntAlbaranes 
   ...
   Begin VB.Frame FrameBotonGnral2 
      ...
      Begin MSComctlLib.Toolbar Toolbar5 
         ...
         BeginProperty Buttons {66833FE8-8583-11D1-B16A-00C0F0283628} 
            NumButtons      =   4
            BeginProperty Button1 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Object.ToolTipText     =   "Nro Series"
               Object.Tag             =   "2"
            EndProperty
            BeginProperty Button2 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Object.ToolTipText     =   "Generar Fra"
               Object.Tag             =   "2"
            EndProperty
            BeginProperty Button3 {66833FEA-8583-11D1-B16A-00C0F0283628} 
               Object.ToolTipText     =   "Marcar Factura"
               Object.Tag             =   "2"
            EndProperty
            BeginProperty Button4 {66833FEA-8583-11D1-B16A-00C0F0283628} 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(13)=   "Text1(22)"
      Tab(1).Control(14)=   "Text1(21)"
      Tab(1).Control(15)=   "Text1(20)"
      Tab(1).Control(16)=   "Text1(19)"
      Tab(1).Control(17)=   "Text1(18)"
      Tab(1).Control(18)=   "Text1(38)"
      Tab(1).Control(19)=   "Text1(23)"
      Tab(1).Control(20)=   "Text1(24)"
      Tab(1).Control(21)=   "Text1(26)"
      Tab(1).Control(22)=   "Text1(25)"
      Tab(1).Control(23)=   "Text1(2)"
      Tab(1).Control(24)=   "Text2(27)"
      Tab(1).Control(25)=   "Text1(27)"
      Tab(1).Control(26)=   "Text2(28)"
      Tab(1).Control(27)=   "FrameHco"
...
Private WithEvents frmEntAlbPre As frmFacEntAlbaranesPrev
Attribute frmEntAlbPre.VB_VarHelpID = -1
...
Dim b As Boolean
    ...
    Select Case Index
        ...
        Case 1 'Busqueda de Cod. Artic
            ...
            '[Monica]21/03/2012: solo traemos lineas cuando se trata de una rectificativa de albaran de venta
            '                    no en el caso de rectificativa de cuota ( he quitado el OR )
            If CodTipoMov = "ART" Then   'Or CodTipoMov = "ARC" Then
...
'    Text1(30).visible = False
    ...
    '[Monica]21/03/2012: quito la rectificativa de cuotas
    If CodTipoMov = "ART" Then   ' Or CodTipoMov = "ARC" Then
        cadList = ""
...
'        Text1(30).visible = False
    ...
    If Me.EsHistorico = False Then
        ...
        Text1(30).Text = Mid(Combo1.Text, 1, 3) 'CodTipoMov
...
'    LimpiarCampos
    ...
    Else
        ...
        If EsHistorico = False Then
            CadenaConsulta = CadenaConsulta & " WHERE codtipom in (" & mCodTipoMov & ")"
        End If
...
'    If InStr(CodTipoMov, "ALV") <> 0 Then
        PosicionarComboTipom Combo1, Mid(Combo1.List(0), 1, 3) '"ALV"
'    End If
...
'    End With
    ...
    With Me.Toolbar5
        ...
        .DisabledImageList = frmppal.imgListComun_BN
        .ImageList = frmppal.imgListComun1
        .Buttons(1).Image = 33 'Nº Serie si lineas con articulos de control Nº serie
        .Buttons(2).Image = 26 'GEnerar factura
        .Buttons(3).Image = 30 'Marcar a facturar
        .Buttons(4).Image = 27 'Imprimir portes
    End With
    ...
    imgFecha(40).Picture = frmppal.imgIcoForms.ListImages(2).Picture
    ...
    Me.FrameFacRec.visible = (CodTipoMov = "ART" Or CodTipoMov = "ARC")
    ...
    If Not EsHistorico Then
        ...
        ElseIf CodTipoMov = "ALT" Then
            Me.Caption = "Albaranes de Telefonia"
        End If
    Else
        NombreTabla = "schalb"
...
'    If CodTipoMov = "ALV" Then
        mCodTipoMov = Mid(mCodTipoMov, 2)
'        PosicionarComboTipom Combo1, "ALV"
'    End If
...
Dim i As Byte
    ...
    If CodTipoMov = "ALV" Or CodTipoMov = "ALT" Then
        Sql = "SELECT codtipom,nomtipom FROM stipom WHERE codtipom LIKE 'AL%' and tipodocu=33"
    Else
        Sql = "SELECT codtipom,nomtipom FROM stipom WHERE codtipom = " & DBSet(CodTipoMov, "T")
    End If
    ...
    Rs.Open Sql, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
    While Not Rs.EOF
        mCodTipoMov = mCodTipoMov & "," & DBSet(Rs!codtipom, "T")
...
Private Sub frmEntAlbPre_DatoSeleccionado(CadenaSeleccion As String)
Dim CadB As String
Dim Aux As String
    ...
    If CadenaSeleccion <> "" Then
        ...
        Screen.MousePointer = vbHourglass
        CadB = ""
        Aux = ValorDevueltoFormGrid(Text1(30), CadenaSeleccion, 1)
        CadB = CadB & " and " & Aux
...
'        End If
        ...
        Set frmEntAlbPre = New frmFacEntAlbaranesPrev
    
        frmEntAlbPre.DatosADevolverBusqueda = "0|1|2|3|"
        frmEntAlbPre.cWhere = CadB
        frmEntAlbPre.Show vbModal
    
        Set frmEntAlbPre = Nothing
...
'    Combo1.visible = False
    ...
    PosicionarComboTipom Combo1, Text1(30)
...
'    DesplazamientoVisible Me.Toolbar1, btnPrimero, b, NumReg
    ...
    BloquearCmb Combo1, Modo = 0 Or Modo = 2 Or Modo = 5 Or Modo = 4
    Combo1.Enabled = Not (Modo = 0 Or Modo = 2 Or Modo = 5 Or Modo = 4)
      
      
'    Combo1.visible = (Me.hcoCodTipoM = "ALV" And Me.EsHistorico = False)
    If Text1(30).Text <> "" Then PosicionarComboTipom Combo1, Text1(30)
...
Dim i As Byte
    ...
    Select Case vDataGrid.Name
        Case "DataGrid1" 'Cod. Almacen
            ...
            vDataGrid.Columns(i).Width = 4000
            ...
            vDataGrid.Columns(i).Width = 1850
            vDataGrid.Columns(i).Alignment = dbgRight
            vDataGrid.Columns(i).NumberFormat = FormatoImporte
...
Private Sub Toolbar5_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    Select Case Button.Index
        ...
        Case 2 'Generar Factura Mostrador
                'o Factura Rectificativa (FRT)
            If Me.RecuperarFactu Then
                BotonRecuperarFactura
            Else
...
'                If Data1.Recordset!codTipoM <> "ALM" Then Exit Sub
                If Me.chkFacturar.Value = 1 Then
                    ...
                    'Facturacion de Albaran de Mostrador
                    frmListadoPed.CodClien = Text1(30) 'CodTipoMov  'utilizamos esta vble para pasarle el tipo de movimiento
                    frmListadoPed.NumCod = Text1(0).Text  'utilizamos esta vble para pasarle el nº albaran
                    frmListadoPed.EstaRecupFact = False
                    frmListadoPed.Escliente = False
                    AbrirListadoPed (222)
...
'[Monica]20/11/2017: quitamos lo del boton cabecera
'    PonerBotonCabecera True
...
'        Me.mnLineas.Enabled = b
    ...
    'Nº Series
    Toolbar5.Buttons(1).Enabled = b And Not EsHistorico
    ...
    Toolbar5.Buttons(4).Enabled = Toolbar1.Buttons(8).Enabled And vParamAplic.ArtPortes <> ""
...
'        bol = ActualizarFecMovCliente
    ...
    '    bol = vTipoMov.IncrementarContador("REG")
        vTipoMov.IncrementarContador (Text1(30))
    End If
...
Dim Campos As String
    ...
    End If
    '[Monica] 04/12/2012: Añadida la condicion de que no este asignado a ningun codigo de cliente
    Sql = Sql & " and (codclien = '' or isnull(codclien))"
   If Sql <> "" Then
        Set frmMen = New frmMensajes
        frmMen.cadWHERE = Sql
...
Dim Sql As String
    ...
    Set vTipoMov = New CTiposMov
    If vTipoMov.Leer(Text1(30)) Then
        Text1(0).Text = vTipoMov.ConseguirContador(Text1(30))
...
'                    Dif = CSng(Data2.Recordset!Cantidad) - CSng(txtAux(3).Text)
        ...
        Else 'Se realizo contro en COMPRAS, Mostramos los Nº y seleccionamos
            If ModificaLineas = 1 Then 'Insertando la linea
                ...
                '===
                '[Monica]04/12/2012: se añade la condicion de que no tenga el cliente asignado
                Sql = Sql & " and (codclien = '' or isnull(codclien))"
...
Dim Sql As String
    ...
    Sql = "select * from sclien where codclien=" & Text1(4).Text
...
'                Text1(29).Text = vCliente.FEnvio
            ...
            End If
'
                'SituacionCliente = miRsAux!codsitua
'
            
            '[Monica]26/09/2012: si es un albaran de cuotas no debe de salir las observaciones del socio
            If Text1(30).Text <> "ALS" Then
...
Dim EsAnterior As Boolean
    ...
    EsAnterior = CDate(Text1(1).Text) < CDate(vParamAplic.FecCambioIva) And Text1(30).Text = "ARC"
...
Dim C As String
    ...
    C = C & " AND slialb.codartic <> " & DBSet(vParamAplic.ArtPortes, "T")
...
Dim codCCoste As String 'centro de coste
    ...
    If ZonaCliente > 0 Then
        ...
        C = Replace(ObtenerWhereCP(True), NombreTabla, NomTablaLineas)
        C = "Select numlinea,codccost from slialb " & C & " and codartic ='" & vParamAplic.ArtPortes & "'"
        miRsAux.Open C, conn, adOpenForwardOnly, adLockPessimistic, adCmdText
        NumRegElim = 0
        If Not miRsAux.EOF Then
