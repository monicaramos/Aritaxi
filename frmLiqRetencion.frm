...
Dim Cad As String
    ...
    If Not Rs.EOF Then
        ...
        Toolbar2.Buttons(1).Enabled = Toolbar2.Buttons(1).Enabled And DBLet(Rs!especial, "N")
        Toolbar2.Buttons(2).Enabled = Toolbar2.Buttons(2).Enabled And DBLet(Rs!Imprimir, "N")
    End If
