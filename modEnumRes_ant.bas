...
'                frmPpal.ImgListPpal.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
''            ElseIf opcio = 5 Then
''                frmPpal.imgListComun1.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
'            End If
...
'        End If
            ...
            If opcio = 1 Then
                frmppalN.ImageList1_N.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            ElseIf opcio = 2 Then
                frmppalN.ImgListComun.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            '++
            ElseIf opcio = 3 Then
                frmppalN.imgListComun_BN.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            ElseIf opcio = 4 Then
                frmppalN.imgListComun_OM.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            ElseIf opcio = 5 Then
                frmppalN.imgListComun16.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            ElseIf opcio = 6 Then
                frmppalN.imgListComun_BN16.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            ElseIf opcio = 7 Then
                frmppalN.imgListComun_OM16.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            ElseIf opcio = 8 Then
                frmppalN.ImageListPPal48.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            ElseIf opcio = 9 Then
                frmppalN.ImageListPpal16.ListImages.Add , sResName & " " & CStr(arrSize) & " " & W & "x" & H, hPicture
            '++
            End If
