...
Begin VB.Form frmManSat 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|smansat|codsat|0000|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Desc|T|N|||smansat|nomsat||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmManSat.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   7
      TabStop         =   0   'False
...
Dim anc As Single
    ...
    txtAux(0).Text = SugerirCodigoSiguienteStr("smansat", "codsat")
...
On Error Resume Next
    ...
    If Adodc1.Recordset.RecordCount <= 0 Then
         ...
         MsgBox "No hay ningún registro en la tabla smansat", vbInformation
...
On Error GoTo Error2
    ...
    '### a mano
    Sql = "¿Seguro que desea eliminar el S.A.T. ?" & vbCrLf
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from smansat where codsat=" & Adodc1.Recordset!codsat
        conn.Execute Sql
        CancelaADODC Adodc1
        CargaGrid ""
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from smansat"
    CargaGrid
End Sub
...
Dim b As Boolean
    ...
    I = 1
        ...
        DataGrid1.Columns(I).Width = 3630
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    If Index = 0 Then PonerFormatoEntero txtAux(Index) 'codsat
End Sub
...
Private Function SepuedeBorrar() As Boolean
    If SePuedeEliminarRelReparacione(1, CStr(Adodc1.Recordset.Fields(0))) Then
        SepuedeBorrar = True
    Else
