...
Begin VB.Form frmLiqContaFac 
   ...
   Begin VB.Label lblTitulo 
      Caption         =   "Contabilizar Facturas Liquidación"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   14.25
         Charset         =   0
...
'[Monica]13/05/2011: al pedir fecha de recepcion hay que comprobar que la fecha de recepcion esté entre limites
...
Dim SQLcuentas As String
    ...
    If Not b Then
        Sql = "No existe la cta contable " & Sql
        Sql = "Comprobando Ctas Contables de Retención en contabilidad... " & vbCrLf & vbCrLf & Sql
...
Dim CtaReten As String
    ...
    If Not RS.EOF Then
        ...
        '[Monica]16/11/2017: añadimos la linea de suplidos en la base de factura de la conta vieja
...
Dim CtaReten As String
    ...
    '[Monica]16/11/2017: añadida la columna de suplidos
    ...
    If Not RS.EOF Then
        ...
        '[Monica]16/11/2017: añadimos la linea de suplidos en las lineas
        If DBLet(RS!Suplidos, "N") <> 0 Then
...
Dim CtaReten As String
    ...
    If Not RS.EOF Then
        ...
        If vSocio.LeerDatos(Socio) Then
            ...
            If Mc.ConseguirContador("1", (CDate(txtCodigo(0).Text) <= CDate(FechaFin) - 365), True) = 0 Then            'guardamos estos valores para utilizarlos cuando insertemos las lineas de la factura
                ...
                DtoPPago = 0
                DtoGnral = 0
                '[Monica]16/11/2017: añadimos los suplidos
    ...
    '            End Select
                ...
                If Not vParamAplic.ContabilidadNueva Then
                    ...
                    Sql = Sql & DBSet(RS!ImporteL, "N") + DBSet(RS!Suplidos, "N") & "," & DBSet(RS!codiiva1, "N") & "," & DBSet(RS!CodIvaSuplidos, "N", Nulo2) & "," & ValorNulo & ",0,"
