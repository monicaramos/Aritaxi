...
'    PonerModo 2
    ...
    'CadenaConsulta = CadenaConsulta & " from sartic inner join salmac on sartic.codartic=salmac.codartic"
    
    
    'AHORA. Marzo 2010
    CadenaConsulta = "Select sartic.codartic,nomartic,codtelem,salmac.canstock,"
    CadenaConsulta = CadenaConsulta & "preciove, if(isnull(porcen1),preciove,preciove*(1+(porcen1/100)))"
    CadenaConsulta = CadenaConsulta & " FROM  (sartic INNER JOIN salmac ON sartic.codartic=salmac.codartic)"
    CadenaConsulta = CadenaConsulta & " LEFT OUTER JOIN tmpinformes ON sartic.codigiva=tmpinformes.codigo1 AND codusu = " & vUsu.Codigo
...
'    End If
    ...
    '### a mano
    tots = "S|txtAux(0)|T|Codigo|1800|;S|txtAux(1)|T|Descripcion|3640|;S|txtAux(2)|T|Cod. Asoc.|1300|;"
    ' ---- [06/11/2009] [LAURA] : añadir la cantidad de stock
    tots = tots & "S|txtAux(3)|T|Stock|1100|;"
    tots = tots & "S|txtAux(4)|T|PVP|1000|;"
    tots = tots & "S|txtAux(5)|T|PVP IVA|1000|;"
    ' ----
