...
Begin VB.Form frmCuotasContaFac 
   ...
   Begin VB.Label lblTitulo 
      Caption         =   "Contabilizar Facturas Cuotas"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   14.25
         Charset         =   0
...
'    cadSelect = CadenaDesdeHastaBD(txtCodigo(31).Text, txtCodigo(32).Text, Codigo, "F")
    ...
    If Check1.Value Then devuelve = "REC"
        ...
        ' ====
            ...
            If Me.OptNormales.Value Then
                DesBloqueoManual ("CUONOR") 'CUOtas NORmales
            Else
                DesBloqueoManual ("CUOEXT") 'CUOtas EXTraordinarias
            End If
...
Dim CCoste2 As Byte
    ...
    If Me.OptNormales.Value Then
        Sql = "CUONOR" 'contabilizar facturas cuotas normales
    Else
        Sql = "CUOEXT" 'contabilizar facturas cuotas extraordinarias
    End If
    ...
    If Me.txtcodigo(31).Text <> "" Then 'anteriores a fechadesde
        ...
        If Check1.Value = 0 Then
            If Me.OptNormales.Value Then
                Sql = Sql & " WHERE codtipom='FCN' and "
            Else
                Sql = Sql & " WHERE codtipom='FCE' and "
            End If
        Else
    ...
    If NumFactu > 0 Then
        ...
        While Not RS.EOF
            ...
            'Segun sea cli o pro
                ...
                Else
                    If PasarFacturaCuotas(Sql, miCC, False, cContaFra) = False And b Then b = False
                End If
