...
Begin VB.Form frmFacHcoFacturas2Prev 
   ...
   ClientTop       =   30
   ClientWidth     =   9405
   Icon            =   "frmFacHcoFacturas2Prev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7125
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacHcoFacturas2Prev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   1
      Top             =   870
   ...
   End
End
Attribute VB_Name = "frmFacHcoFacturas2Prev"
