...
Begin VB.Form frmListadoOfer 
   ...
   Begin VB.Frame FrameEstVentasFam 
      ...
      Top             =   0
      Width           =   7035
      Begin VB.CheckBox chkOrdenxfra 
         Caption         =   "Ordenar por factura"
         Enabled         =   0   'False
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   9.75
      ...
      End
   End
   Begin VB.Frame FrameAporCertificado 
      Height          =   5385
      Left            =   45
      TabIndex        =   415
      Top             =   0
      ...
      Begin VB.TextBox txtCodigo 
         ...
         Width           =   1350
      End
      Begin VB.CommandButton CmdAcepAportaciones 
         Caption         =   "&Aceptar"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   9.75
      ...
      End
   End
   Begin VB.Frame FrameEstLiquidaciones 
      Height          =   4395
      Left            =   0
      TabIndex        =   397
      Top             =   0
      ...
      Begin VB.ComboBox Combo3 
         ...
         Width           =   2925
      End
      Begin VB.CommandButton cmdAceptarLiquida 
         Caption         =   "&Aceptar"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   9.75
      ...
      End
      Begin VB.Label Label9 
         Caption         =   "Detalle Facturación Liquidacion Socios"
         BeginProperty Font 
            Name            =   "Tahoma"
            Size            =   14.25
            Charset         =   0
   ...
   Begin MSComDlg.CommonDialog cd1 
      ...
      _Version        =   393216
   End
   Begin VB.Frame FrameServiciosSocios 
      Height          =   5760
      Left            =   0
      TabIndex        =   369
      Top             =   0
      ...
      Begin VB.CommandButton cmdCancel 
         ...
         Width           =   1065
      End
      Begin VB.CommandButton CmdAcepServSocios 
         Caption         =   "&Aceptar"
         BeginProperty Font 
            Name            =   "Verdana"
            Size            =   9.75
   ...
   Begin VB.Frame FrameFacRectif 
      ...
      Begin VB.ComboBox cboTipomov 
         ...
         Height          =   360
         Index           =   0
         ItemData        =   "frmListadoOfer.frx":0010
         Left            =   2160
         List            =   "frmListadoOfer.frx":0012
         Style           =   2  'Dropdown List
         TabIndex        =   183
         Top             =   1185
         Width           =   2910
   ...
   Begin VB.Frame FrameClientes 
      ...
      Begin VB.CommandButton cmdBajar 
         Height          =   510
         Left            =   8160
         Picture         =   "frmListadoOfer.frx":0014
         Style           =   1  'Graphical
         TabIndex        =   35
         Top             =   2505
         Width           =   435
      ...
      Begin VB.CommandButton cmdSubir 
         Height          =   510
         Left            =   8160
         Picture         =   "frmListadoOfer.frx":031E
         Style           =   1  'Graphical
         TabIndex        =   34
         Top             =   1720
         Width           =   435
   ...
   Begin VB.Frame FrameClienInactivos 
      ...
      Begin VB.Frame frameCliexFacturas 
         ...
         Begin VB.ComboBox cboTipomov 
            ...
            Height          =   360
            Index           =   2
            ItemData        =   "frmListadoOfer.frx":0628
            Left            =   920
            List            =   "frmListadoOfer.frx":062A
            Style           =   2  'Dropdown List
            TabIndex        =   291
            Top             =   840
            Width           =   1875
         ...
         Begin VB.Image imgClearCmbTipomov 
            Height          =   240
            Left            =   2880
            Picture         =   "frmListadoOfer.frx":062C
            Top             =   840
            Width           =   240
         End
         Begin VB.Label Label14 
...
Private Sub CmdAcepAportaciones_Click()
...
Dim nomDocu As String 'Nombre de Informe rpt de crystal
    ...
    indRPT = 58
    Titulo = "Certificados Aportaciones a Socios"
    conSubRPT = True
    ...
    '--------------------------------------------
     If txtcodigo(20).Text <> "" Or txtcodigo(21).Text <> "" Then
        ...
        If Not PonerDesdeHasta(campo, "N", 20, 21, "") Then Exit Sub
    End If
...
'    If cadselect = "" Then Exit Sub
    ...
    'Parametro Fecha
    cadParam = cadParam & "pFecha=""" & txtcodigo(19).Text & """|"
    numParam = numParam + 1
    'Parametro Importe
    cadParam = cadParam & "pImporte=" & txtcodigo(18).Text & "|"
    numParam = numParam + 1
    'Parametro Presidente
    cadParam = cadParam & "pPresidente=""" & txtcodigo(22).Text & """|"
    numParam = numParam + 1
    'Parametro Secretario
    cadParam = cadParam & "pSecretario=""" & txtcodigo(23).Text & """|"
    numParam = numParam + 1
    'serie
    cadParam = cadParam & "pSerie=""" & txtcodigo(24).Text & """|"
    numParam = numParam + 1
    ' nro de titulo
    cadParam = cadParam & "pNroTitulo=" & txtcodigo(25).Text & "|"
    numParam = numParam + 1
    ...
    If MsgBox("¿ Impresion correcta para actualizar ?", vbQuestion + vbYesNo + vbDefaultButton1) = vbYes Then
        If ActualizarTablas(cadSelect) Then
...
Private Function ActualizarTablas(vCadselect As String) As Boolean
Dim Sql As String
...
Dim rs As ADODB.Recordset
    ...
    SQLinsert = "insert into sclien_aportaciones (codsocio,numlinea,nroapor,serieapor,importe,fecha) values "
    
    Sql = "select codclien, coalesce(max(sclien_aportaciones.numlinea),0) + 1  from sclien left join sclien_aportaciones on sclien.codclien = sclien_aportaciones.codsocio where " & vCadselect
    ...
    While Not rs.EOF
        ...
        nLin = DBLet(rs.Fields(1), "N")
        
        SqlValues = SqlValues & ",(" & DBSet(rs.Fields(0), "N") & "," & DBSet(nLin, "N") & "," & DBSet(i, "N") & ","
        SqlValues = SqlValues & DBSet(txtcodigo(24), "T") & "," & DBSet(txtcodigo(18), "N") & "," & DBSet(txtcodigo(19).Text, "F") & ")"
...
eActualizarTablas:
    ...
    If b And Err.Number = 0 Then
        ActualizarTablas = True
        conn.CommitTrans
    Else
        ActualizarTablas = False
        conn.RollbackTrans
        MuestraError Err.Number, "Actualizar Tablas", Err.Description
    End If

End Function


Private Sub CmdAcepServSocios_Click()
...
Dim Sql As String
   ...
   numParam = numParam + 1
    ...
    '---------------------------------------------
    If txtcodigo(8).Text <> "" Or txtcodigo(6).Text <> "" Then
        Codigo = "{shilla.codsocio}"
        If Not PonerDesdeHasta(Codigo, "N", 8, 6, "pDHSocio=""Socio:") Then Exit Sub
    End If
    
    
    'Desde/Hasta codigo de cliente
    '---------------------------------------------
    If txtcodigo(10).Text <> "" Or txtcodigo(11).Text <> "" Then
        Codigo = "{shilla.codclien}"
        If Not PonerDesdeHasta(Codigo, "N", 10, 11, "pDHCliente=""Cliente:") Then Exit Sub
    End If
    
    
    'Desde/Hasta fecha de servicio
    '---------------------------------------------
    If txtcodigo(9).Text <> "" Or txtcodigo(82).Text <> "" Then
        Codigo = "{shilla.fecha}"
        If Not PonerDesdeHasta(Codigo, "F", 9, 82, "pDHFecha=""Fecha:") Then Exit Sub
    End If
    ...
    ' Añadimos la condicion de que sean de credito
    If Not AnyadirAFormula(cadFormula, "{shilla.tipservi}=1") Then Exit Sub
    If Not AnyadirAFormula(cadSelect, "{shilla.tipservi}=1") Then Exit Sub
    
    
    ' Añadimos la condicion de que no esten liquidados
    If Not AnyadirAFormula(cadFormula, "{shilla.liquidadosocio}=0") Then Exit Sub
    If Not AnyadirAFormula(cadSelect, "{shilla.liquidadosocio}=0") Then Exit Sub
    ...
    If OptMail(0).Value Then
        ...
        If Not AnyadirAFormula(cadSelect, "not sclien.maiclie1 is null and sclien.maiclie1<>''") Then Exit Sub
        If Not AnyadirAFormula(cadFormula, "not isnull({sclien.maiclie1}) and {sclien.maiclie1}<>''") Then Exit Sub
    
        Dim SqlEMail As String
        SqlEMail = cadFormula
    
        indRPT = 55
        Titulo = "Servicios de Socios"
        
        If Not PonerParamRPT(indRPT, cadParam, numParam, nomDocu, True, "") Then Exit Sub
    
        conSubRPT = False
    
        '[Monica]22/06/2018: cambiado todo por codsocio (antes estaba enlazado por numeruve)
        Sql = "select count(*) from shilla inner join sclien on shilla.codsocio = sclien.codclien where " & cadSelect
        ...
        If TotalRegistros(Sql) <> 0 Then
            ...
            '[Monica]22/06/2018: pos si no puede cargarlo y envia otra cosa
            If Dir(App.Path & "\docum.pdf") <> "" Then Kill App.Path & "\docum.pdf"
        
            '[Monica]22/06/2018: cambiado todo por codsocio (antes estaba enlazado por numeruve)
            EnviarEMailMulti3 cadSelect, Titulo, nomDocu, "shilla inner join sclien on shilla.codsocio = sclien.codclien", SqlEMail     ' "rSocioCarta.rpt", Tabla  'email para socios
        Else
            If MsgBox("No hay socios a enviar servicios por email. ¿ Continuar ?", vbQuestion + vbYesNo + vbDefaultButton1) = vbNo Then Exit Sub
        End If
    
        If Not AnyadirAFormula(CadSelect1, "sclien.maiclie1 is null or sclien.maiclie1=''") Then Exit Sub
        If Not AnyadirAFormula(CadFormula1, "isnull({sclien.maiclie1}) or {sclien.maiclie1}=''") Then Exit Sub
    
        Sql = "select count(*) from shilla inner join sclien on shilla.codsocio = sclien.codclien  where " & CadSelect1
        ...
        If TotalRegistros(Sql) <> 0 Then
            ...
            LlamarImprimir False, False
        Else
            MsgBox "No hay Socios para imprimir servicios.", vbExclamation
        End If
    Else
        If HayRegParaInforme("shilla inner join sclien  on shilla.codsocio = sclien.codclien", cadSelect) Then
            indRPT = 55
            Titulo = "Servicios de Socios"
...
'    If Me.ChkResumen.Value Then
'            indRPT = 55
'            Titulo = "Resumen Servicios de Socios"
'
'            If Not PonerParamRPT(indRPT, cadParam, numParam, nomDocu, False, "") Then Exit Sub
'
'            nomRPT = Replace(nomDocu, ".rpt", "Resumen.rpt")
'
'            LlamarImprimir False, False
'
'
...
Dim Tabla As String
    ...
    Else
        ...
        '[Monica]21/05/2019: para ordenar el informe por nro de fra
        If OpcionListado = 231 Then
            If Me.chkOrdenxfra.Value = 1 Then nomRPT = "rFacEstCliImpxFra.rpt"
        End If
...
Private Sub cmdAceptarLiquida_Click()
'Listados estadistica ventas por familia
'Listados de Compras
Dim campo As String
Dim Cad As String
...
Dim devuelve As String
    ...
    'Cadena para seleccion D/H CLIENTE
    '--------------------------------------------
    If txtcodigo(12).Text <> "" Or txtcodigo(13).Text <> "" Then
        campo = "{sfactusoc.codsocio}"
        'Parametro Desde/Hasta Cliente
        Cad = "pDHSocio=""Socio: "
        If Not PonerDesdeHasta(campo, "N", 12, 13, Cad) Then Exit Sub
    End If
    ...
    If txtcodigo(16).Text <> "" Or txtcodigo(17).Text <> "" Then
        campo = "{sfactusoc.fecfactu}"
        Cad = "pDHFecha=""Fecha Fact.: "
        If Not PonerDesdeHasta(campo, "F", 16, 17, Cad) Then Exit Sub
    End If
    
    Tabla = "sfactusoc"

    ' [Monica]04/04/2011: Añadido el combo de tipo de factura de venta socio
    If Mid(Combo3.Text, 1, 5) <> "Todos" Then
        If Not AnyadirAFormula(cadFormula, "{sfactusoc.codtipom} = '" & Mid(Combo3.Text, 1, 3) & "'") Then Exit Sub
        If Not AnyadirAFormula(cadSelect, "{sfactusoc.codtipom} = '" & Mid(Combo3.Text, 1, 3) & "'") Then Exit Sub
    End If
    ...
    indRPT = 57
    Titulo = "Detalle Liquidaciones Socios"
...
Private Sub CmdAportaciones_Click()
...
Private Sub Form_Activate()
    If PrimeraVez Then
        ...
        Select Case OpcionListado
            ...
            Case 34 '34: Informe Ofertas Efectuadas
...
Dim devuelve As String
    ...
    Me.imgBuscarOfer(6).Picture = frmppal.imgIcoForms.ListImages(1).Picture
    For kCampo = 1 To 4
    ...
    Me.FrameServiciosSocios.visible = False
    Me.FrameEstLiquidaciones.visible = False
    Me.FrameAporCertificado.visible = False
...
'    FrameEnvioFacMail.visible = False
    ...
    Select Case OpcionListado
        ...
        Case 92 ' servicios de socios
            H = 5760
            W = 8190
            PonerFrameVisible Me.FrameServiciosSocios, True, H, W
...
'            CargarComboTipoMov (2)
        ...
        Case 230, 231 '230: Estadistica ventas por familia
            ...
            If OpcionListado = 231 Then
                ...
                '[Monica]21/05/2019: ordenar por factura en lugar de por socio
                Me.chkOrdenxfra.visible = True
                Me.chkOrdenxfra.Enabled = True
                Me.chkOrdenxfra.top = 3450
            End If
            W = 7035
...
'            Combo1.ListIndex = 0
        ...
        Case 241 ' informe de liquidaciones de socios
            H = 4395
            W = 7035
            PonerFrameVisible FrameEstLiquidaciones, True, H, W
        
        
        Case 242 ' impresion de certificados de socios
            H = 5385
            W = 7035
            PonerFrameVisible FrameAporCertificado, True, H, W
            txtcodigo(19).Text = Format(Now, "dd/mm/yyyy")
            txtcodigo(18).Text = vParamAplic.ImpTituloAlta
            txtcodigo(22).Text = vParamAplic.AporPresidente
            txtcodigo(23).Text = vParamAplic.AporSecretario
            txtcodigo(24).Text = vParamAplic.AporSerie
            txtcodigo(25).Text = Format(vParamAplic.AporNumero, "0000000")
...
'formulario de mensajes: frmMensajes
    If CadenaSeleccion <> "" Then
        ...
        Else
            If OpcionListado = 190 Or OpcionListado = 191 Or OpcionListado = 242 Then 'Socios
...
Private Sub imgBuscarOfer_Click(index As Integer)
    Select Case index
        ...
        Case 1, 2, 4, 5, 9, 10, 46, 47, 56, 57   'Cod. CLIENTE
            Select Case index
                Case 1, 2: indCodigo = index + 9
                Case 4, 5: indCodigo = index - 1
                Case 2: indCodigo = 7 + index
        ...
        Case 7, 11, 12, 19, 20, 25, 26  'Cod. AGENTE
            Select Case index
...
Dim EsNomCod As Boolean
    ...
    Select Case index
        'FECHA Desde Hasta
        Case 1, 2, 9, 16, 17, 19, 31, 32, 49, 50, 69, 70, 72, 74, 75, 77, 78, 82, 85, 86, 88, 89, 92, 93, 98, 99, 104, 105, 108, 109, 9
            If txtcodigo(index).Text = "" Then Exit Sub
            PonerFormatoFecha txtcodigo(index)
            
            
        Case 71, 83, 84   'Nº de OFERTA/FACTURA
            If PonerFormatoEntero(txtcodigo(index)) Then
                txtcodigo(index).Text = Format(txtcodigo(index).Text, "0000000")
            End If
        
        Case 5, 63, 64, 81, 116 'CARTA de la Oferta
            EsNomCod = True
            Tabla = "scartas"
            codCampo = "codcarta"
            NomCampo = "descarta"
        ...
        Case 20, 21, 43, 44, 79, 80, 96, 97, 6, 8, 12, 13 'Cod. socio
            EsNomCod = True
            Tabla = "sclien"
            codCampo = "codclien"
            NomCampo = "nomclien"
        ...
        Case 18 ' importe de aportacion
            PonerFormatoDecimal txtcodigo(index), 1
        
        Case 3, 4, 10, 11, 27, 28 ' codigo cliente
            EsNomCod = True
            Tabla = "scliente"
            codCampo = "codclien"
            NomCampo = "nomclien"
        ...
        Case 29, 30, 39, 40, 45, 46  'Cod. AGENTE
            EsNomCod = True
            Formato = "0000"
        ...
        Case 47, 51, 117, 118 'Cod. TRABAJADOR
            EsNomCod = True
            Tabla = "straba"
            codCampo = "codtraba"
            NomCampo = "nomtraba"
...
Private Sub EnviarEMailMulti(cadWHERE As String, cadTit As String, cadRpt As String, cadTabla As String, Optional cFormula As String)
Dim Sql As String
Dim rs As ADODB.Recordset
...
On Error GoTo EEnviar
    ...
    ElseIf cadTabla = "sclien" Then
        ...
        Sql = "SELECT codclien,nomclien,maiclie1,maiclie1 "
    Else
        Sql = "SELECT sclien.codclien,sclien.nomclien,sclien.maiclie1,sclien.maiclie1 "
    End If
...
'              MsgBox "Sin mail para el proveedor: " & Format(RS!codProve, "000000") & " - " & RS!nomprove, vbExclamation
    ...
    If cont > 0 Then
        ...
        If OpcionListado = 92 Then
            Sql = "Servicios: "
            If txtcodigo(9).Text <> "" Then Sql = Sql & " desde " & txtcodigo(9).Text
            If txtcodigo(82).Text <> "" Then Sql = Sql & " hasta " & txtcodigo(82).Text
            Sql = Sql & "|"
            Sql = Sql & "Servicios de crédito "
            If txtcodigo(9).Text <> "" Then Sql = Sql & " desde " & txtcodigo(9).Text
            If txtcodigo(82).Text <> "" Then Sql = Sql & " hasta " & txtcodigo(82).Text
            Sql = Sql & "|"
        Else
...
Dim rs As ADODB.Recordset
    ...
    Sql = "select codtipom, nomtipom from stipom where codtipom in ('FAV','FTI','FCE','FCN','FAR','FRT','FRC','FTI','FAT') "
...
Private Sub EnviarEMailMulti2(cadWHERE As String, cadTit As String, cadRpt As String, cadTabla As String)
Dim Sql As String
Dim rs As ADODB.Recordset
Dim cad1 As String, cad2 As String, Lista As String
Dim cont As Integer
...
Private Sub EnviarEMailMulti3(cadWHERE As String, cadTit As String, cadRpt As String, cadTabla As String, Optional cFormula As String)
Dim Sql As String
Dim rs As ADODB.Recordset
Dim cad1 As String, cad2 As String, Lista As String
Dim cont As Integer
        ...
        If cad1 <> "" Then 'HAY email --> ENVIAMOS e-mail
            With frmImprimir
                ...
                ElseIf cadTabla = "sclien" Then
                    ...
                    .Opcion = 91
                Else
                    Sql = cFormula & " and {sclien.codclien}=" & rs.Fields(0)
                    .Opcion = 92
                End If
                .FormulaSeleccion = Sql
                .EnvioEMail = True
