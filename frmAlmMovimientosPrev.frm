...
Begin VB.Form frmAlmMovimientosPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   9405
   Icon            =   "frmAlmMovimientosPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7125
   ...
   Begin VB.TextBox txtAux 
      ...
      Left            =   3540
      TabIndex        =   11
      Tag             =   "Nom Almacen|T|N|||salmpr|nomalmac||N|"
      Text            =   "Text2"
      Top             =   4920
      Width           =   3975
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAlmMovimientosPrev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   7
      Top             =   870
   ...
   End
End
Attribute VB_Name = "frmAlmMovimientosPrev"
...
Private Sub BotonBuscar()
    ...
    CargaGrid NombreTabla & ".codmovim is null "
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select " & NombreTabla & ".codmovim, " & NombreTabla & ".fecmovim, " & NombreTabla & ".codalmac, salmpr.nomalmac "
    CadenaConsulta = CadenaConsulta & " from " & NombreTabla & " inner join salmpr on " & NombreTabla & ".codalmac = salmpr.codalmac "
    CadenaConsulta = CadenaConsulta & " where  (1=1)  "
    If cWhere <> "" Then CadenaConsulta = CadenaConsulta & " and " & cWhere
    
    
    For I = 0 To 2
        txtAux(I).Tag = Replace(txtAux(I).Tag, "scamov", NombreTabla)
    Next I
...
'    adodc1.ConnectionString = Conn
    ...
    '********************* canviar el ORDER BY *********************++
    If CampoOrden = "" Then
        Sql = Sql & " ORDER BY fecmovim desc, codmovim desc "
    Else
    ...
    tots = tots & "S|txtAux(2)|T|Almacén|1495|;S|txtAux(3)|T|Nombre|3805|;"
