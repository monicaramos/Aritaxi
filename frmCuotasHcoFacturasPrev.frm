...
Begin VB.Form frmCuotasHcoFacturasPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   9405
   Icon            =   "frmCuotasHcoFacturasPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7125
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmCuotasHcoFacturasPrev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   1
      Top             =   870
   ...
   End
End
Attribute VB_Name = "frmCuotasHcoFacturasPrev"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "scafac.codclien is null "
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select scafac.codtipom, scafac.numfactu, scafac.fecfactu, scafac.codclien, sclien.nomclien "
    CadenaConsulta = CadenaConsulta & " from scafac inner join sclien on scafac.codclien = sclien.codclien "
