...
Begin VB.Form frmFacClientes2 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   2
      Tag             =   "Nombre Comercial|T|N|||scliente|nomcomer||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   3195
   End
   ...
   End
End
Attribute VB_Name = "frmFacClientes2"
...
Private Sub BotonBuscar()
    CargaGrid "codclien= -1"  'para vaciar los datos del Grid
    'Buscar
    txtAux(0).Text = ""
    txtAux(1).Text = ""
    txtAux(2).Text = ""
...
'    PonerModo 2
    ...
    'Cadena consulta
    CadenaConsulta = "Select codclien,nomclien,nomcomer from scliente"
    BotonBuscar
'    CargaGrid
End Sub
