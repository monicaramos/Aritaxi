...
Begin VB.Form frmtipave 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|stipave|codave|0000|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Desc|T|N|||stipave|nomave||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmtipave.frx":000C
      Height          =   4715
      Left            =   120
      TabIndex        =   8
      TabStop         =   0   'False
...
Dim anc As Single
    ...
    txtAux(0).Text = SugerirCodigoSiguienteStr("stipave", "codave")
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from stipave"
    CargaGrid
End Sub
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    If Index = 0 Then PonerFormatoEntero txtAux(Index) 'codave
End Sub
