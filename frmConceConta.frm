...
Begin VB.Form frmConceConta 
   ...
   Begin VB.ComboBox Combo1 
      Appearance      =   0  'Flat
      Height          =   315
      ItemData        =   "frmConceConta.frx":000C
      Left            =   2520
      List            =   "frmConceConta.frx":000E
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   4
      Tag             =   "Código de Cuenta|T|N|||conceptos|codconce||S|"
      Text            =   "Dat"
      Top             =   4680
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   30
      TabIndex        =   5
      Tag             =   "Descripción de la Cuenta|T|N|||cuentas|nommacta|||"
      Text            =   "Dato2"
      Top             =   4680
      Width           =   1395
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmConceConta.frx":0010
      Height          =   4410
      Left            =   120
      TabIndex        =   3
      Top             =   540
...
Private Sub CargaGrid(Optional vSQL As String)
    ...
    'codmacta, nommacta
    tots = "S|txtAux(0)|T|Código|800|;S|txtAux(1)|T|Descripción|2300|;N||||0|;S|Combo1|C|Tipo|1200|;"
