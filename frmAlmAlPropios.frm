...
Begin VB.Form frmAlmAlPropios 
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código almacen propio|N|N|0|999|salmpr|codalmac|000|S|"
      Text            =   "Dat"
      Top             =   4920
      Width           =   800
   End
...
Private Sub BotonVerTodos()
    ...
    If Adodc1.Recordset.RecordCount <= 0 Then
         MsgBox "No hay ningún registro en la tabla salmpr", vbInformation
...
Dim b As Boolean
    ...
    I = 1
        ...
        DataGrid1.Columns(I).Width = 3540
