...
Begin VB.Form frmGesHisLlamAntPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   9405
   Icon            =   "frmGesHisLlamAntPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7125
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmGesHisLlamAntPrev.frx":000C
      Height          =   5265
      Left            =   120
      TabIndex        =   7
      Top             =   870
   ...
   End
End
Attribute VB_Name = "frmGesHisLlamAntPrev"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "shilla1.codclien is null "
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select shilla1.fecha, shilla1.hora, shilla1.codsocio, sclien.nomclien, shilla1.numeruve "
    CadenaConsulta = CadenaConsulta & " from shilla1 inner join sclien on shilla1.codsocio = sclien.codclien "
