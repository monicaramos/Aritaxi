...
Begin VB.Form frmRepEntReparacionesPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   9405
   Icon            =   "frmRepEntReparacionesPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7125
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmRepEntReparacionesPrev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   5
      Top             =   870
   ...
   End
End
Attribute VB_Name = "frmRepEntReparacionesPrev"
...
'    adodc1.ConnectionString = Conn
    ...
    '********************* canviar el ORDER BY *********************++
    If CampoOrden = "" Then
        Sql = Sql & " ORDER BY numserie desc "
    Else
    ...
    tots = "S|txtAux(0)|T|Serie|2005|;S|txtAux(1)|T|Codigo|2000|;S|txtAux2(1)|T|Artículo|3195|;"
