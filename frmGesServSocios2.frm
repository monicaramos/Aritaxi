...
Begin VB.Form frmGesServSocios2 
   ...
   Icon            =   "frmGesServSocios2.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   7
      Tag             =   "Numero V|N|N|||sfactsoctr_serv|numeruve|000000|N|"
      Text            =   "Nro V"
      Top             =   3570
      Visible         =   0   'False
      Width           =   1065
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   6
      Tag             =   "NroServicios|N|N|||sfactsoctr_serv|nroservicio|0000000|N|"
      Text            =   "NroServici"
      Top             =   3570
      Visible         =   0   'False
      Width           =   1065
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   100
      TabIndex        =   5
      Tag             =   "Destino|T|N|||sfactsoctr_serv|destino|||"
      Text            =   "Destino"
      Top             =   3570
      Visible         =   0   'False
      Width           =   2205
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   100
      TabIndex        =   4
      Tag             =   "Origen|T|N|||sfactsoctr_serv|origen|||"
      Text            =   "Origen"
      Top             =   3570
      Visible         =   0   'False
      Width           =   2625
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   2
      Tag             =   "Fecha|F|N|||sfactsoctr_serv|fecha|dd/mm/yyyy||"
      Text            =   "fecha"
      Top             =   3570
      Visible         =   0   'False
      Width           =   975
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   6
      TabIndex        =   0
      Tag             =   "Cod.Cliente|N|N|0|999999|sfactsoctr_serv|codclien|000000|S|"
      Text            =   "client"
      Top             =   3600
      Visible         =   0   'False
      Width           =   735
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   8
      TabIndex        =   3
      Tag             =   "Hora|H|N|||sfactsoctr_serv|hora|hh:mm:ss||"
      Text            =   "hora"
      Top             =   3570
      Visible         =   0   'False
      Width           =   615
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   1
      Tag             =   "Fecha|F|N|||sfactsoctr_serv|fecfactu|dd/mm/yyyy|S|"
      Text            =   "fecfactu"
      Top             =   3570
      Visible         =   0   'False
      Width           =   975
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmGesServSocios2.frx":000C
      Height          =   4110
      Left            =   240
      TabIndex        =   18
      Top             =   720
   ...
   End
End
Attribute VB_Name = "frmGesServSocios2"
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    NombreTabla = "sfactsoctr_serv" 'Tabla de facturas asociados
    Ordenacion = " ORDER BY fecha, hora "
    
    CadenaConsulta = "Select sfactsoctr_serv.numeruve, sfactsoctr_serv.fecfactu, sfactsoctr_serv.fecha, sfactsoctr_serv.hora, "
    CadenaConsulta = CadenaConsulta & " sfactsoctr_serv.origen, sfactsoctr_serv.destino, sfactsoctr_serv.importe"
    CadenaConsulta = CadenaConsulta & " from " & NombreTabla
    CadenaConsulta = CadenaConsulta & " WHERE sfactsoctr_serv.numeruve = " & DBSet(NumerUve, "N")
    CadenaConsulta = CadenaConsulta & " and sfactsoctr_serv.fecfactu = " & DBSet(FecFactura, "F")
...
On Error GoTo ECarga2
    ...
    tots = "N|txtAux(0)|T|Nro V|850|;"
    tots = tots & "N|txtAux(1)|T|FecFac|1150|;S|txtAux(2)|T|Fecha|1150|;S|cmdAux(1)|B||0|;S|txtAux(3)|T|Hora|850|;S|txtAux(4)|T|Origen|3450|;"
    tots = tots & "S|txtAux(5)|T|Destino|3450|;S|txtAux(7)|T|NroServicio|1200|;S|txtAux(8)|T|Cliente|900|;S|txtAux(6)|T|Importe|1250|;"
...
Dim Sql As String
    ...
    Sql = "Select sfactsoctr_serv.numeruve, sfactsoctr_serv.fecfactu, sfactsoctr_serv.fecha, sfactsoctr_serv.hora, "
    Sql = Sql & " sfactsoctr_serv.origen, sfactsoctr_serv.destino,"
    Sql = Sql & " sfactsoctr_serv.nroservicio, sfactsoctr_serv.codclien, sfactsoctr_serv.importe "
    Sql = Sql & " from " & NombreTabla
    Sql = Sql & " where  sfactsoctr_serv.numeruve = " & DBSet(NumerUve, "N")
    Sql = Sql & " and  sfactsoctr_serv.fecfactu = " & DBSet(FecFactura, "F")
    

    If enlaza Then
        If EsBusqueda And CadenaBusqueda <> "" Then Sql = Sql & CadenaBusqueda
    Else
        Sql = Sql & " and sfactsoctr_serv.numeruve = -1"
    End If
    Sql = Sql & Ordenacion
    MontaSQLCarga = Sql
End Function
...
'Ver todos
    ...
    CadenaConsulta = "Select * from " & NombreTabla & " where numeruve = " & DBSet(NumerUve, "N") & " and fecfactu = " & DBSet(FecFactura, "F") & Ordenacion
    PonerCadenaBusqueda
