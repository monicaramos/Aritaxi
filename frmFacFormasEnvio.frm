...
Begin VB.Form frmFacFormasEnvio 
   ...
   Begin VB.ComboBox CboEtiqueta 
      ...
      TabIndex        =   2
      Tag             =   "Opción Imprimir etiqueta|N|N|||senvio|impetiqu||N|"
      Top             =   4920
      Width           =   975
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código|N|N|0|999|senvio|codenvio|000|S|"
      Text            =   "Codigo"
      Top             =   4920
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripción|T|N|||senvio|nomenvio||N|"
      Text            =   "Descripcion"
      Top             =   4920
      Width           =   1395
   End
...
Dim tots As String
    ...
    '### a mano
    tots = "S|txtAux(0)|T|Código|700|;S|txtAux(1)|T|Denominación|2700|;S|CboEtiqueta|C|Etiqueta|820|;"
