...
Begin VB.Form frmRepMotivosPend 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Motivos Pendientes Reparación"
   ClientHeight    =   6180
   ClientLeft      =   45
   ClientTop       =   30
   ClientWidth     =   5775
   Icon            =   "frmRepMotivosPend.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6180
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   2
      TabIndex        =   0
      Tag             =   "Código Motivo|N|N|0|99|smotre|codmotre|00|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   20
      TabIndex        =   1
      Tag             =   "Desc. Motivo|T|S|||smotre|nommotre||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmRepMotivosPend.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   7
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmRepMotivosPend"
...
Dim anc As Single
    ...
    txtAux(0).Text = SugerirCodigoSiguienteStr("smotre", "codmotre")
...
On Error Resume Next
    ...
    If Adodc1.Recordset.RecordCount <= 0 Then
         MsgBox "No hay ningún registro en la tabla smotre", vbInformation
...
Dim Sql As String
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from " & NombreTabla & " where codmotre=" & Adodc1.Recordset!codmotre
        conn.Execute Sql
...
Error2:
    Screen.MousePointer = vbDefault
    If Err.Number <> 0 Then MuestraError Err.Number, "Eliminar Motivo", Err.Description
End Sub
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    Select Case Button.Index
        ...
        Case 8   'Imprimir Listado de Motivos
            Me.Hide
            AbrirListado (61)
            Me.Show vbModal
    End Select
...
Dim tots As String
    ...
    Else
        Sql = CadenaConsulta
    End If
    Sql = Sql & " ORDER BY codmotre"
    
    CargaGridGnral DataGrid1, Me.Adodc1, Sql, False
    
    tots = "S|txtAux(0)|T|Motivo|1000|;S|txtAux(1)|T|Denominación|3600|;"
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    If Index = 0 Then PonerFormatoEntero txtAux(Index) 'cod motivo
End Sub
