...
'    b = DataGrid1.Enabled
    ...
    Else
        Sql = "Dir."
    End If
    tots = tots & "S|txtAux(2)|T|Fecha|1290|;S|txtAux(0)|T|Socio|850|;S|txtAux2(0)|T|Nombre Socio|2540|;"
    ...
    tots = tots & "S|txtAux(1)|T|Prov.|850|;S|txtAux2(1)|T|Nombre Proveedor|2540|;"
