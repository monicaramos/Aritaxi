...
'                frmEMail.Show vbModal
    ...
    'If Me.outTipoDocumento = 0 Then
    '    Unload Me
    'ElseIf Me.chkEMAIL.Value = 1 Then Unload Me
    'End If
    Unload Me
...
Dim otromail As String
    ...
    If outTipoDocumento < 50 Then
        ...
        Else
            ...
            otromail = "maiclie1"
        End If
        campoemail = DevuelveDesdeBD(conAri, campoemail, "scliente", "codclien", Me.outCodigoCliProv, "N") ' , otromail)
        If campoemail = "" Then campoemail = otromail
    Else
        If outTipoDocumento < 100 Then
            'Para provedores
            '[Monica]27/09/2012: si enviamos un pedido de compra por email cogemos la direccion del dpto de compras
            '                    he añadido el not a toda la condicion
            If Not (outTipoDocumento = 51 Or outTipoDocumento = 52 Or outTipoDocumento = 53) Then
                campoemail = "maiprov1"
                otromail = "maiprov2"
            Else
                campoemail = "maiprov2"
