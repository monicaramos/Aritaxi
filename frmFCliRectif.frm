...
Private WithEvents frmRectifPre As frmFCliRectifPrev
Attribute frmRectifPre.VB_VarHelpID = -1
...
Private Sub frmRectifPre_DatoSeleccionado(CadenaSeleccion As String)
Dim CadB As String
Dim Aux As String
...
'        End If
        ...
        Set frmRectifPre = New frmFCliRectifPrev
    
        frmRectifPre.DatosADevolverBusqueda = "0|1|2|3|"
        frmRectifPre.cWhere = CadB
        frmRectifPre.Show vbModal
    
        Set frmRectifPre = Nothing
