...
Begin VB.Form frmFCliRectifPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   9405
   Icon            =   "frmFCliRectifPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7125
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFCliRectifPrev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   1
      Top             =   870
   ...
   End
End
Attribute VB_Name = "frmFCliRectifPrev"
...
Private Sub BotonBuscar()
    ...
    CargaGrid "scaalbcli.codclien is null "
    '*******************************************************************************
    'Buscar
    For I = 0 To txtAux.Count - 1
        txtAux(I).Text = ""
...
Private Sub Form_Load()
    ...
    CadenaConsulta = "select scaalbcli.codtipom, scaalbcli.numalbar, scaalbcli.fechaalb, scaalbcli.codclien, scliente.nomclien "
    CadenaConsulta = CadenaConsulta & " from scaalbcli inner join scliente on scaalbcli.codclien = scliente.codclien "
