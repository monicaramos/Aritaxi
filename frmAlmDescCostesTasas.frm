...
Begin VB.Form frmAlmDescCostesTasas 
   ...
   ClientTop       =   330
   ClientWidth     =   5265
   Icon            =   "frmAlmDescCostesTasas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0||sunidesc|codigo|000|S|"
      Text            =   "Codi"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   40
      TabIndex        =   1
      Tag             =   "Descripcion|T|N|||sunidesc|descripcion||N|"
      Text            =   "Descripcion"
      Top             =   5040
      Width           =   2835
   End
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAlmDescCostesTasas.frx":000C
      Height          =   4845
      Left            =   120
      TabIndex        =   9
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmAlmDescCostesTasas"
...
Dim anc As Single
    ...
    LimpiarCampos
    txtAux(0).Text = SugerirCodigoSiguienteStr("sunidesc", "codigo")
...
On Error Resume Next
    ...
    If Adodc1.Recordset.RecordCount <= 0 Then
         ...
         MsgBox "No hay ningún registro en la tabla Descripcion costes tasa", vbInformation
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from sunidesc"
    CargaGrid
End Sub
