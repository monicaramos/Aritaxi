...
Begin VB.Form frmLlamadasTipo 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Tipo llamadas"
   ClientHeight    =   6015
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4620
   Icon            =   "frmLlamadasTipo.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   4
      TabIndex        =   0
      Tag             =   "Código|N|N|0|9999|sllama1|codllama1|0000|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Descripcion|T|N|||sllama1|nomllama1||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmLlamadasTipo.frx":000C
      Height          =   4715
      Left            =   120
      TabIndex        =   8
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmLlamadasTipo"
...
Dim anc As Single
    ...
    txtAux(0).Text = SugerirCodigoSiguienteStr("sllama1", "codllama1")
...
On Error Resume Next
    ...
    If adodc1.Recordset.RecordCount <= 0 Then
         ...
         MsgBox "No hay ningún registro en la tabla sllama1", vbInformation
...
On Error GoTo Error2
    ...
    '### a mano
    SQL = "¿Seguro que desea eliminar el tipo?" & vbCrLf
    ...
    If MsgBox(SQL, vbQuestion + vbYesNo) = vbYes Then
        ...
        SQL = "Delete from sllama1 where codllama1=" & adodc1.Recordset!codllama1
        conn.Execute SQL
        CancelaADODC adodc1
        CargaGrid ""
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from sllama1"
    CargaGrid
End Sub
...
Dim b As Boolean
    ...
    i = 1
        ...
        DataGrid1.Columns(i).Width = 2930
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    If Index = 0 Then PonerFormatoEntero txtAux(Index) 'codllama1
End Sub
