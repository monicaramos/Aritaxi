...
Begin VB.Form frmFacZonas 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Zonas de Clientes"
   ClientHeight    =   6015
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   4590
   Icon            =   "frmFacZonas.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   6015
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   3
      TabIndex        =   0
      Tag             =   "Código Zona Cliente|N|N|0|999|szonas|codzonas|000|S|"
      Text            =   "Dat"
      Top             =   5040
      Width           =   800
   End
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   25
      TabIndex        =   1
      Tag             =   "Nombre Zona Cliente|T|N|||szonas|nomzonas||N|"
      Text            =   "Dato2"
      Top             =   5040
      Width           =   1395
   End
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFacZonas.frx":000C
      Height          =   4725
      Left            =   240
      TabIndex        =   8
      TabStop         =   0   'False
...
Dim anc As Single
    ...
    'Obtenemos la siguiente numero de codigo de Zona
    txtAux(0).Text = SugerirCodigoSiguienteStr("szonas", "codzonas")
...
Private Sub BotonBuscar()
    CargaGrid "codzonas= -1"  'para vaciar los datos del Grid
    txtAux(0).Text = ""
    txtAux(1).Text = ""
    LLamaLineas 750, 1
    PonerFoco txtAux(0)
...
On Error Resume Next
    ...
    If adodc1.Recordset.RecordCount <= 0 Then
         ...
         MsgBox "No hay ningún registro en la tabla szonas", vbInformation
...
Private Sub Toolbar1_ButtonClick(ByVal Button As MSComctlLib.Button)
    ...
    Case 10 'Imprimir Listado de Zonas
            Me.Hide
            AbrirListado (21) 'OpcionListado=21
            Me.Show vbModal
    Case 11 'Salir
            mnSalir_Click
    End Select
...
Dim tots As String
    ...
    '### a mano
    tots = "S|txtAux(0)|T|Zonas|700|;S|txtAux(1)|T|Denominación|2600|;"
...
Dim b As Boolean
    ...
    'comprobar que ya existe el codigo de zona
