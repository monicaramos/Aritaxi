...
Begin VB.Form frmAlmMarcas 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmAlmMarcas.frx":000C
      Height          =   4545
      Left            =   120
      TabIndex        =   7
      TabStop         =   0   'False
   ...
   End
End
Attribute VB_Name = "frmAlmMarcas"
...
Dim anc As Single
    ...
    anc = ObtenerAlto(DataGrid1, 10 + 10)
    
    'Obtenemos la siguiente numero de código de Marca
    txtAux(0).Text = SugerirCodigoSiguienteStr("smarca", "codmarca")
...
On Error GoTo Error2
    ...
    If MsgBox(Sql, vbQuestion + vbYesNo) = vbYes Then
        ...
        Sql = "Delete from smarca where codmarca=" & Adodc1.Recordset!codmarca
        conn.Execute Sql
        CancelaADODC Adodc1
        CargaGrid ""
...
'    chkVistaPrevia.Value = CheckValueLeer(Name)
    ...
    'Cadena consulta
    CadenaConsulta = "Select * from smarca"
    CargaGrid
End Sub
...
Dim b As Boolean
    ...
    i = 1
        ...
        DataGrid1.Columns(i).Width = 3130
...
Private Sub txtAux_LostFocus(Index As Integer)
    ...
    If Index = 0 Then PonerFormatoEntero txtAux(Index) 'codmarca
End Sub
