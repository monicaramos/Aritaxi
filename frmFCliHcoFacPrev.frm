...
Begin VB.Form frmFCliHcoFacPrev 
   ...
   ClientTop       =   30
   ClientWidth     =   9405
   Icon            =   "frmFCliHcoFacPrev.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   7125
   ...
   Begin VB.TextBox txtAux 
      ...
      MaxLength       =   10
      TabIndex        =   3
      Tag             =   "Cod. Socio|N|N|0|999999|scafaccli|codclien|000000|N|"
      Top             =   4920
      Width           =   1695
   End
   Begin VB.TextBox txtAux 
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      Bindings        =   "frmFCliHcoFacPrev.frx":000C
      Height          =   5295
      Left            =   120
      TabIndex        =   1
      Top             =   870
   ...
   End
End
Attribute VB_Name = "frmFCliHcoFacPrev"
