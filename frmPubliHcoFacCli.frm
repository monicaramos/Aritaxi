...
Begin VB.Form frmPubliHcoFacCli 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Tab(1).Control(6)=   "txtAux3(1)"
      Tab(1).Control(7)=   "txtAux3(0)"
      Tab(1).Control(8)=   "txtAux(5)"
      Tab(1).Control(9)=   "txtAux(3)"
      Tab(1).Control(10)=   "txtAux(2)"
      Tab(1).Control(11)=   "txtAux(1)"
      Tab(1).Control(12)=   "txtAux(0)"
      Tab(1).Control(13)=   "cmdObserva"
      Tab(1).Control(14)=   "Text2(0)"
      ...
      Tab(1).Control(20)=   "DataGrid1"
      Tab(1).Control(21)=   "DataGrid2"
      Tab(1).Control(22)=   "FrameObserva"
      Tab(1).Control(23)=   "Text3(2)"
      Tab(1).Control(24)=   "Text2(2)"
      Tab(1).Control(25)=   "Text3(1)"
      Tab(1).Control(26)=   "Text2(1)"
      Tab(1).Control(27)=   "Text3(8)"
      Tab(1).Control(28)=   "Text3(6)"
      Tab(1).Control(29)=   "Text3(7)"
      Tab(1).Control(30)=   "Text3(5)"
      Tab(1).Control(31)=   "Text3(4)"
      Tab(1).Control(32)=   "Text3(3)"
      Tab(1).Control(33)=   "Text2(3)"
...
EComprobarCobroArimoney:
    ...
    Set vR = Nothing
End Function
'uff me entere que no podré cogerme la baja alli y aqui no...
'grrrrrrrr asi que la semana del 02/08 tendré que apechugar
'por ahi me hago un certificado de 48hs y otro día voy al medico
'asi que mira tendré posibilidades de no trabajar toda la semana
'como esta, asi que nada ya veremos que tal...
'por ahora tendré q aguantarme y en todo caso pedir la baja por
...
'pediré la baja por riesgo y a currar desde casa a hablar por tel
...
'jijijijiji q mocion... a veces tengo la sensación que sera Iker
...
'muy bien, grrrrr eso que anoche me bañe y hoy taba limpita
'pero me parece que me equivoque con la blusa que me puse, la de
'hilo del corte inglés, y es muy pesada y calurosa, asi que nada
'cuando llegue a casa me la cambiaré y me pondré algo mas fresco
'solo que quedan 3 jornadas y media para mis vacacionessssss
'jejeje son las 11.08hs y ya he hecho bastante en el programa
'aunque estoy esperando una contestación de manolo para poder
...
'quiero de verdad seguir en este trabajo y además tener a mi bebe
'y poder continuar con media jornada más tiempo, y cuidar a mi
...
'por fin encontre el amor que siempre busque... y lo mejor él me
'ama como yo a él...
...
'a casita a dormir.... porfiiii madre mia que sueño que tengo no
'puedo mas snif snif snif snif, pasado mañana entro en la 7º
'semana y cuando vuelva de vacaciones ya esta en la 8º ahhhhh q
'mocion, y en nada a ver a nuestro bebucoooo, faltan 29 días...
