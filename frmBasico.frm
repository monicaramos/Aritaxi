...
Private Sub BotonAnyadir()
    ...
    Else
        If vTag1.TipoDato = "N" Then
            NumF = SugerirCodigoSiguienteStr(tabla, CampoCP)
        End If
    End If
    '********************************************************************
...
'    '****************** canviar la consulta *********************************+
'    CadenaConsulta = "SELECT inciden.codincid, inciden.nomincid"
'    CadenaConsulta = CadenaConsulta & " FROM inciden"
...
Private Sub mnModificar_Click()
    ...
    '-------------------------
    If BLOQUEADesdeFormulario(Me, 0) Then BotonModificar
End Sub
...
Private Sub printNou()
    With frmImprimir2
        ...
        .OtrosParametros2 = "pEmpresa='" & vEmpresa.nomempre & "'|pOrden={" & tabla & "." & CampoCP & "}|"
