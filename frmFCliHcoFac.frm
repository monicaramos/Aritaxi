...
Begin VB.Form frmFCliHcoFac 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      TabPicture(0)   =   "frmFCliHcoFac.frx":000C
      ...
      Tab(2).Control(0)=   "FrameToolAux1"
      Tab(2).Control(1)=   "txtAux2(1)"
      Tab(2).Control(2)=   "txtAux2(0)"
      Tab(2).Control(3)=   "txtAux4(13)"
      Tab(2).Control(4)=   "txtAux4(5)"
      Tab(2).Control(5)=   "txtAux4(6)"
      Tab(2).Control(6)=   "txtAux4(7)"
      Tab(2).Control(7)=   "txtAux4(8)"
      Tab(2).Control(8)=   "txtAux4(9)"
      Tab(2).Control(9)=   "txtAux4(10)"
      Tab(2).Control(10)=   "txtAux4(11)"
      Tab(2).Control(11)=   "txtAux4(2)"
      Tab(2).Control(12)=   "txtAux4(1)"
      Tab(2).Control(13)=   "txtAux4(0)"
      Tab(2).Control(14)=   "txtAux4(3)"
      Tab(2).Control(15)=   "txtAux4(4)"
      Tab(2).Control(16)=   "txtAux4(12)"
      Tab(2).Control(17)=   "DataGrid3"
      Tab(2).Control(18)=   "Data4"
      Tab(2).Control(19)=   "Label1(50)"
      Tab(2).Control(20)=   "Label1(48)"
      ...
      Begin VB.TextBox txtAux 
         ...
         MaxLength       =   255
         TabIndex        =   193
         Tag             =   "Nro Expediente|T|S|||slifaccli|nroexpediente||N|"
         Text            =   "NroExpediente"
         Top             =   4320
         Visible         =   0   'False
         Width           =   1470
      ...
      Begin VB.TextBox txtAux4 
         ...
         MaxLength       =   15
         TabIndex        =   161
         Tag             =   "Socio |N|N|||scafaccli_serv|codsocio|000000||"
         Text            =   "socio"
         Top             =   2040
         Visible         =   0   'False
         Width           =   855
      ...
      Begin VB.TextBox txtAux4 
         ...
         MaxLength       =   15
         TabIndex        =   160
         Tag             =   "Uve|N|N|||scafaccli_serv|numeruve|000000|S|"
         Text            =   "Uve"
         Top             =   2040
         Visible         =   0   'False
         Width           =   855
      ...
      Begin VB.Frame FrameFactura 
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   15
            TabIndex        =   51
            Tag             =   "Importe Retención|N|S|||scafaccli|impreten|#,###,###,##0.00|N|"
            Text            =   "Text1 7"
            Top             =   450
            Width           =   1485
         End
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   5
            TabIndex        =   50
            Tag             =   "% IVA 1|N|S|0|99.90|scafaccli|porcret|#0.00|N|"
            Text            =   "Text1 7"
            Top             =   450
            Width           =   645
         End
      ...
      Begin VB.Frame FrameCliente 
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   10
            TabIndex        =   26
            Tag             =   "Fecha Hasta|F|S|||scafaccli|fechasta|dd/mm/yyyy||"
         ...
         Begin VB.TextBox Text1 
            ...
            MaxLength       =   10
            TabIndex        =   25
            Tag             =   "Fecha Desde|F|S|||scafaccli|fecdesde|dd/mm/yyyy||"
            Text            =   "Text1 Text1 Text1 Te"
            Top             =   2520
            Width           =   1275
         End
      ...
      Begin MSDataGridLib.DataGrid DataGrid2 
         Bindings        =   "frmFCliHcoFac.frx":0060
         Height          =   2310
         Left            =   -74760
         TabIndex        =   93
         Top             =   840
      ...
      Begin MSDataGridLib.DataGrid DataGrid3 
         Bindings        =   "frmFCliHcoFac.frx":0075
         Height          =   4410
         Left            =   -74760
         TabIndex        =   148
         Top             =   1155
      ...
      Begin MSDataGridLib.DataGrid DataGrid1 
         Bindings        =   "frmFCliHcoFac.frx":008A
         Height          =   2025
         Left            =   -74760
         TabIndex        =   80
         Top             =   3795
...
'========== VBLES PRIVADAS ====================
Private WithEvents frmHcoFacPre As frmFCliHcoFacPrev 'Form para busquedas
Attribute frmHcoFacPre.VB_VarHelpID = -1
        ...
        Case 4  'MODIFICAR
            If DatosOk Then
               If ModificarFactura Then
                    ...
                    '[Monica]13/11/2017: añadimos los suplidos
                    If CCur(ImporteSinFormato(ComprobarCero(Text1(47).Text))) <> Suplidos Then cad1 = cad1 & "Suplidos: " & Suplidos & " a " & Text1(47).Text & ";"
                    
                    
                    If CCur(ImporteSinFormato(ComprobarCero(Text1(38).Text))) <> TotFac Then cad1 = cad1 & "Tot.Fac.: " & TotFac & " a " & Text1(38).Text & ";"
                    
                    '[Monica]18/10/2018: fecha desde y fecha hasta
                    If Text1(52) <> FecDes Then cad1 = cad1 & "Fec.Des: " & FecDes & " a " & Text1(52).Text & ";"
                    If Text1(53) <> FecHas Then cad1 = cad1 & "Fec.Has: " & FecHas & " a " & Text1(53).Text & ";"
...
Dim EnTesoreria  As String
    ...
    '[Monica]13/11/2017: añadimos los suplidos
    Suplidos = CCur(ImporteSinFormato(ComprobarCero(Text1(47).Text)))
    ...
    '[Monica]18/10/2018: por sin han modificado la fecha
    FecDes = Text1(52)
    FecHas = Text1(53)
...
'    Set LOG = Nothing
    ...
    '[Monica]13/11/2017: añadimos los suplidos
    Suplidos = ComprobarCero(Text1(47).Text)
...
'    anc = ObtenerAlto(Me.DataGrid1)
    ...
    If vEmpresa.TieneAnalitica Then
        txtAux(12).Text = DataGrid1.Columns(21).Text
    Else
        txtAux(12).Text = DataGrid1.Columns(20).Text
    End If
    ...
    Select Case grid
        Case "DataGrid1"
            ...
            For jj = 0 To txtAux.Count - 1
                If jj = 3 Or jj = 4 Or jj = 8 Or jj = 12 Then
...
Private Sub frmHcoFacPre_DatoSeleccionado(CadenaSeleccion As String)
Dim CadB As String
Dim Aux As String
...
Dim devuelve As String
        ...
        With frmImprimir
            ...
            .NombrePDF = DevuelveDesdeBDNew(conAri, "scryst", "pdfrpt", "codcryst", "54", "N")
        '------ > Listado 47 = rFacPubli.rpt
            .Opcion = 101
            .ConSubInforme = True
            .Show vbModal
...
Private Sub CalcularDatosFactura2(indice As Integer)
    ...
    If (Modo = 4 Or Modo = 5) And ((indice >= 26 And indice <= 37)) Then
        ...
        '[Monica]28/06/2018: introducimos la retencion
        If Text1(50).Text <> "" Then PorcRet = CCur(Text1(50).Text)
        ImpReten = Round2(BaseImpo * PorcRet / 100, 0)
        If ImpReten <> 0 Then Text1(51).Text = Format(ImpReten, "###,##0.00")
        ...
        TotalFac = CCur(ImporteSinFormato(ComprobarCero(Text1(32).Text))) + _
                   ...
                   CCur(ImporteSinFormato(ComprobarCero(Text1(37).Text))) - _
                   CCur(ImporteSinFormato(ComprobarCero(Text1(51).Text)))
 '                   CCur(ImporteSinFormato(ComprobarCero(Text1(47).Text)))
...
'        cadB = cadB & " and scafaccli.codtipom='" & CodTipoMov & "'" 'Solo seleccionamos los del Movimiento, aqui los FAV
        ...
        '[Monica]28/06/2018: para buscar un identificador de servicio en una factura
        CadenaConsulta = CadenaConsulta & " LEFT JOIN scafaccli_serv ON  scafaccli.codtipom = scafaccli_serv.codtipom and scafaccli.numfactu= scafaccli_serv.numfactu and scafaccli.fecfactu = scafaccli_serv.fecfactu "
...
'        devuelve = "0|1|2|"
        ...
        Set frmHcoFacPre = New frmFCliHcoFacPrev
    
        frmHcoFacPre.DatosADevolverBusqueda = "0|1|2|3|"
        
        If CadB <> "" Then CadB = " and " & CadB
        CadB = " scafaccli.codtipom in ('FAC','FRN','FVC') " & CadB
        
        frmHcoFacPre.cWhere = CadB
        frmHcoFacPre.Show vbModal
    
        Set frmHcoFacPre = Nothing
...
'    Text1(38).BackColor = &HC0C0FF    'Total factura
    ...
    '[Monica]28/06/2018: bloqueamos la retencion, solo se puede buscar
    BloquearTxt Text1(50), (Modo <> 1)
    BloquearTxt Text1(51), (Modo <> 1)
...
Dim b As Boolean
    ...
    Else
        ...
        Sql = Sql & ", nroexpediente = " & DBSet(txtAux(12).Text, "T")
...
Dim tots As String
    ...
    Select Case vDataGrid.Name
        Case "DataGrid1" 'Cod. Almacen
            ...
            tots = tots & "S|txtAux(0)|T|Alm.|500|;S|txtAux(1)|T|Artículo|1600|;S|txtAux(2)|T|Nombre Art.|3550|;"
            tots = tots & "N||||0|;S|txtAux(3)|T|Cantidad|900|;N||||0|;S|txtAux(4)|T|Precio|1200|;S|txtAux(5)|T|OP|400|;S|txtAux(6)|T|Dto 1|600|;S|txtAux(7)|T|Dto 2|600|;S|txtAux(8)|T|Importe|1740|;"
            'TRAZA
...
'                tots = tots & "N||||0|;S|cmdaux|B|||;N||||0|;N||||0|;"
            ...
            End If
            'numlote
            tots = tots & "N||||0|;S|txtAux(12)|T|Expediente|2000|;"
...
'             SQL = "SELECT codtipom,numfactu,fecfactu,codtipoa,numalbar, fechaalb,"
         ...
         Case "DataGrid3" ' llamadas de la factura
            ...
            tots = tots & "S|txtAux4(10)|T|Identif.|1000|;S|txtAux4(12)|T|Importe|1145|;N||||0|;N||||0|;"
...
Dim Sql As String
    ...
    Select Case Opcion
        Case 1
            Sql = "SELECT codtipom, numfactu, fecfactu, numalbar, numlinea, codalmac, codartic, nomartic, ampliaci, cantidad,numbultos, precioar, origpre, dtoline1, dtoline2, importel ,codprovex, nomprove,codccost,numlote, nroexpediente"
...
Dim Sql As String
    ...
    '[Monica]28/06/2018: ponemos la retencion en cordoba
    fac.PorRet = CCur(ComprobarCero(Text1(50).Text))
